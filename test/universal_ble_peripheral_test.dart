...
//   String? updatedCharacteristicId;
//   String? subscribedCharacteristicId;
...
//   @override
//   Future<UniversalBlePeripheralReadinessState> getAvailabilityState() async =>
//       UniversalBlePeripheralReadinessState.ready;

//   @override
//   Future<List<String>> getServices() async => const [];
...
//     final mapped = service.toPigeonService(primary: true);
...
//     expect(descriptors!.single.uuid, BleUuidParser.string('2902'));
...
//         [CharacteristicProperty.notify],
//         [
//           BleDescriptor('2908', value: Uint8List.fromList([0x00, 0x01])),
//         ],
//       ),
//     ]);
...
//     final mapped = data.toPigeonManufacturerData();
...
//   test('static API normalizes service IDs for remove/start', () async {
//     final fake = _FakePeripheralPlatform();
//     UniversalBlePeripheral.setInstance(fake);

//     await UniversalBlePeripheral.removeService('180f');
//     await UniversalBlePeripheral.startAdvertising(services: const ['180f']);

//     expect(fake.removedServiceId, BleUuidParser.string('180f'));
//     expect(fake.advertisedServices?.single, BleUuidParser.string('180f'));
//   });
...
//   test('static API exposes platform capabilities', () async {
//     final fake = _FakePeripheralPlatform();
//     UniversalBlePeripheral.setInstance(fake);
...
//   test('static API normalizes characteristic IDs in APIs', () async {
//     final fake = _FakePeripheralPlatform();
//     UniversalBlePeripheral.setInstance(fake);
...
//     );
//     await UniversalBlePeripheral.getSubscribedClients('2a19');

//     expect(fake.updatedCharacteristicId, BleUuidParser.string('2a19'));
//     expect(fake.subscribedCharacteristicId, BleUuidParser.string('2a19'));
//   });

//   test('static API forwards max notify length deviceId', () async {
//     final fake = _FakePeripheralPlatform();
//     UniversalBlePeripheral.setInstance(fake);
