...
class UniversalBleWriteCommand {
  ...
  static UniversalBleWriteCommand decode(Object result) {
    result as List<Object?>;
    return UniversalBleWriteCommand(
      deviceId: result[0]! as String,
      service: result[1]! as String,
      characteristic: result[2]! as String,
      value: result[3]! as Uint8List,
      bleOutputProperty: result[4]! as int,
    );
  }
  ...
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  bool operator ==(Object other) {
    if (other is! UniversalBleWriteCommand || other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
      return true;
...
class _PigeonCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is int) {
      ...
      buffer.putUint8(136);
      writeValue(buffer, value.encode());
    }    else if (value is UniversalBleWriteCommand) {
      buffer.putUint8(137);
      writeValue(buffer, value.encode());
    } else {
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 137: 
        return UniversalBleWriteCommand.decode(readValue(buffer)!);
      default:
...
class UniversalBlePlatformChannel {
  ...
  Future<void> batchWrite(List<UniversalBleWriteCommand> commands) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.universal_ble.UniversalBlePlatformChannel.batchWrite$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
