...
bool UniversalManufacturerDataFilter::operator==(const UniversalManufacturerDataFilter& other) const {
  return PigeonInternalDeepEquals(company_identifier_, other.company_identifier_) && PigeonInternalDeepEquals(data_, other.data_) && PigeonInternalDeepEquals(mask_, other.mask_);
}
...
size_t UniversalManufacturerDataFilter::Hash() const {
  size_t result = 1;
  result = result * 31 + PigeonInternalDeepHash(company_identifier_);
  result = result * 31 + PigeonInternalDeepHash(data_);
  result = result * 31 + PigeonInternalDeepHash(mask_);
  return result;
}

size_t PigeonInternalDeepHash(const UniversalManufacturerDataFilter& v) {
  return v.Hash();
}
