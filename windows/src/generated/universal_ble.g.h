...
class AndroidOptions {
 public:
  ...
  const AndroidScanCallbackType* callback_type() const;
  void set_callback_type(const AndroidScanCallbackType* value_arg);
  void set_callback_type(const AndroidScanCallbackType& value_arg);
 ...
 private:
  ...
  std::optional<AndroidScanCallbackType> callback_type_;
